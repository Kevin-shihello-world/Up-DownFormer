...
def main():
    ...
    if args.task_name is not None:
        ...
        raw_datasets = load_from_disk('dataset_/glue/qnli')
    ...
    model = BertForSequenceClassification.from_pretrained('model_/bert-base-cased')
    ####
    ...
    class CustomBertAttention(BertAttention):
        def __init__(self, config, position_embedding_type="absolute"):
            ...
            self.self = BertSelfAttention_new_1(config, position_embedding_type=position_embedding_type)
        ...
        def forward(self,
            ...
            outputs = (custom_output,) + self_outputs[1:] 
            return outputs
    class CustomBertAttention_(BertAttention):
        def __init__(self, config, position_embedding_type="absolute"):
            super().__init__(config)
            self.output = BertSelfOutput(config)
            self.self = BertSelfAttention_new_not_1(config, position_embedding_type=position_embedding_type)
